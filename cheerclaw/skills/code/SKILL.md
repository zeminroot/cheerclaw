...
description: Use it when the user requests code implementation. Coding workflow with planning, implementation, verification, and testing for clean software development.
